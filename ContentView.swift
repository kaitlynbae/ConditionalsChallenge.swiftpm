...
struct ContentView: View {
    ...
    func determineOutput1() -> String
    {
     ...
     if  totalMoney > firstChoiceCost{
        stringToReturn = "You have more than enough money to purchase your first choice."
    
        
    } else if totalMoney == totalMoney {
        stringToReturn = "You have just enough money to purchase your first choice. "
        } else { 
        stringToReturn = "You do not have enough money to purchase your first choice."
    }
